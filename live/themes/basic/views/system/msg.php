...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javaScript" src="http://local/phpcms/statics/js/jquery.min.js"></script>
        <script language="JavaScript" src="http://local/phpcms/statics/js/admin_common.js"></script>
    </head>
    <body>
        <div class="showMsg" style="text-align:center">
            ...
            <div class="bottom">
                <a href="<?php echo $this->createUrl($msg['url']) ?>">如果您的浏览器没有自动跳转，请点击这里</a>
                <?php if(!empty($msg['url'])) :?>
                <script language="javascript">setTimeout("redirect('<?php echo $this->createUrl($msg['url']) ?>');",1250);</script> 
                    <?php  endif;?>
