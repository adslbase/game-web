...
<?php echo $form->error($model, 'pay_account'); ?>
        ...
        <div class="row">
                ...
                <?php echo $form->textField($model, 'config[alipay_key]'); ?>
<?php echo $form->error($model, 'config[alipay_key]'); ?>
        </div>
        <div class="row">
               <label> 合作者身份(parterID)：</label> 
                <?php echo $form->textField($model, 'config[alipay_partner]'); ?>
<?php echo $form->error($model, 'config[alipay_partner]'); ?>
        </div>
        <div class="row">
               <label> 选择接口类型：</label> 
                  <?php echo $form->dropDownList($model, 'config[service_type]', ConstantDefine::getAlipayServiceType()); ?>
<?php echo $form->error($model, 'config[service_type]'); ?>
        </div>
