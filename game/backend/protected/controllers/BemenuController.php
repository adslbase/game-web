...
class BemenuController extends BeController{
        ...
        public function __construct($id,$module=null)
	{
		 parent::__construct($id,$module);
                 $this->menu=array(
                        array('label'=>t('管理菜单'), 'url'=>array('admin'),'linkOptions'=>array('class'=>'button')),
                        array('label'=>t('添加菜单'), 'url'=>array('create'),'linkOptions'=>array('class'=>'button')),
                );
	...
	{         
              ...
              $this->menu=array_merge($this->menu,                       
                        array(
                            array('label'=>t('修改菜单'), 'url'=>array('update','id'=>$id),'linkOptions'=>array('class'=>'button')),
                            array('label'=>t('查看菜单'), 'url'=>array('view','id'=>$id),'linkOptions'=>array('class'=>'button'))
                        )
                    );
