...
class BemenuitemController extends BeController {
        ...
        public function __construct($id, $module = null) {
                ...
                $this->menu = array(
                    array('label' => t('管理菜单项'), 'url' => array('admin'), 'linkOptions' => array('class' => 'button')),
                    array('label' => t('增加菜单项'), 'url' => array('create'), 'linkOptions' => array('class' => 'button')),
                );
        }
        ...
        public function actionView() {
                ...
                $this->menu = array_merge($this->menu, array(
                    array('label' => t('修改菜单项'), 'url' => array('update', 'id' => $id), 'linkOptions' => array('class' => 'button')),
                    array('label' => t('查看菜单项'), 'url' => array('view', 'id' => $id), 'linkOptions' => array('class' => 'button'))
                        )
                );
