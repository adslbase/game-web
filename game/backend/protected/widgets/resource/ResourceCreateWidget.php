<?php
        ...
        class ResourceCreateWidget extends CWidget
        {
                ...
                protected function renderContent()
                {
                        ...
                        if (isset($_POST['ResourceUploadForm']))
                        {
                                ...
                                if ($process)
                                {
                                        ...
                                        if ($resource->save())
                                        {
                                                ...
                                                {
                                                        $this->render('backwidgets.views.resource.resource_upload_iframe_return', array('resource' => $resource));
                                                        Yii::app()->end();
                                                }
                                                else
                                                {
                                                        user()->setFlash('success', t('上传附件成功!'));
                        ...
                        $this->render('backwidgets.views.resource.resource_form_widget', array('model' => $model, 'is_new' => $is_new, 'types_array' => $types_array));
                }
