...
<? else: ?>    
        ...
        <div id="uc1" >
                <div class="uc_l">
                      <span style="float:left;width:55px;color:white;font-size:14px;">用户名:</span>    <?php echo $form->textField($model, 'username', array('size' => 30, 'class' => 'user_in')); ?>
                        <?php echo $form->error($model, 'username'); ?>
                
                
                </div>
                <div class="uc_l">
                       <span style="float:left;width:55px;color:white">密码:</span>    <?php echo $form->passwordField($model, 'password', array('size' => 30, 'class' => 'user_in')); ?>
