  ...
  <div class="wrap">
    ...
    <div class="Headerbar">
      ...
      <div class="NavBar">
        <ul class="navs1ji">
          ...
          <li class="naziliao">
            <p class="nbts"><a title="游戏资料"  href="http://g.marstv.com/dxz/gl.html">游戏资料</a></p>
          </li>
          <li class="napay">
      ...
      <!--导航结束-->
      <div class="LogoPost"><a title="大侠传" href="#">大侠传</a></div>
    ...
    <div class="NrkuangBar">
      ...
      <div class="side_RtBar">
        <!--路径区-->
        <div class="PathQu">
          <div class="shuo_tu"><span class="t_ziliao">游戏资料</span></div>
          <div class="shuo_lu">当前位置： <a href="home.html">首页</a> > <span class="cur">游戏资料</span></div>
        </div>
        <!--路径区End-->
        <!--游戏资料内容页面开始-->
        <div class="NeikuangBar">
          <div class="pages_gamenr">
            <!--正文区开始-->
            <div class="nrzw_bar">
              <div class="nrzw_bts"><?php echo $object['object_name'] ?></div>
              <!--正文区开始-->
              <div class="nrzw_bar">
                <div class="nrzw_date"><span class="fa_date">发布时间：<?php echo date('Y-m-d', $object['object_date']) ?></span></div>
                <div class="nrzw_txts">
                 <?php echo $object['meta_value'] ?>　　</p>
                </div>
                <!--正文字结束-->
