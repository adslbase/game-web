...
indexEye.init();
            ...
            <div class="hmNewsBar">
              ...
              <div class="nxNrshowGroup">
                <div class="nxListGroup">
                  ...
                  <p><span class="date"><?php echo date('m-d', $new['object_date']) ?></span><span class="leis"><a href="http://dxz.marstv.com/xw.html">[新闻]</a></span><a href="<?php echo $this->createUrl('dxz/view', array('id' => $new['object_id'])); ?>" title=""  class="zw" ><?php echo str_cut($new['object_name'], 50); ?></a></p>
				  <?php endforeach; ?>
                </div>
              </div>
            </div>
        ...
        <!--四组广告START-->
        <div class="hotushow">
		    <a title="新服活动" target="_blank" href="http://g.marstv.com/dxztest/254.html">
			   <img src="http://g.marstv.com/assets/751ad8b7/css/dxz/images/dxgw/pic/hd1.gif" alt="公测礼包" width="177" height="88"   border="0" />
			</a>
			<a title="VIP特权" target="_blank" href="http://g.marstv.com/dxztest/253.html">
        ...
        <div class="hmRtnrBar">
          ...
          <div class="hmRtnrside_b">
          	<div class="guguqu">
              <p><embed src="http://player.youku.com/player.php/sid/XNDkyMTU2NzE2/v.swf" quality="high" width="190"  align="middle" allowScriptAccess="sameDomain" allowFullscreen="true" type="application/x-shockwave-flash"></embed></p> 
            </div>
		  <div class="guguqu">
