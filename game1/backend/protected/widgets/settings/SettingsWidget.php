    ...
    protected function showSystemForm(){
        ...
        if(isset($_POST['SettingSystemForm']))
        {
                ...
                if($model->validate()){
                        ...
                        user()->setFlash('success',t('修改系统设置成功!'));                                                                                            

                }
        }

        $this->render('backwidgets.views.settings.settings_system_widget',array('model'=>$model));
    }
    ...
    protected function showGeneralForm(){
        ...
        if(isset($_POST['SettingGeneralForm']))
        {
                ...
                if($model->validate()){
                        ...
                        user()->setFlash('success',t('修改常用配置成功！'));                                                                                            

                }
        }

        $this->render('backwidgets.views.settings.settings_general_widget',array('model'=>$model));
    }
}
