...
<div class="row" >
        ...
        <div class="type_form" id="type_form_div_<?php echo ConstantDefine::MENU_TYPE_URL; ?>" style="display: none">
             <input type="text" name="type_form_<?php echo ConstantDefine::MENU_TYPE_URL; ?>" id="type_form_<?php echo ConstantDefine::MENU_TYPE_URL; ?>" value="<?php echo $model->value;?>" class="text_type_form simple_text_type_form"/>
        </div>
       ...
       <div class="type_form" id="type_form_div_<?php echo ConstantDefine::MENU_TYPE_STRING; ?>" style="display: none">
           <input type="text" name="type_form_<?php echo ConstantDefine::MENU_TYPE_STRING; ?>" id="type_form_<?php echo ConstantDefine::MENU_TYPE_STRING; ?>" value="<?php echo $model->value;?>" class="text_type_form simple_text_type_form" />
       </div>
...
<div class="row buttons">
        <?php echo CHtml::submitButton(t('保存'),array('class'=>'button')); ?>
