                                ...
                                <ul id='list-item-ul' name="list-item" class="ui-sortable" >    
                                        <li name="new-item" id="li_item_id-0" align="left" style="display:none;" class="list_item_wrapper">                            
                                                ...
                                                <div class="item_div_wrapper">                                                             
                                                        <span class="item_name"><?php echo t('下级内容'); ?></span>                                
                                                        <span class="item_id" style="display:none">0</span>
                                                        <span class="item_parent_id" style="display:none">0</span>
                                                        <br />
                                                        <span class="item_buttons">
                                                                <a href="javascript:void(0)" onClick="fnEditItem(this);" name="editItem"><?php echo t('编辑'); ?></a> |
                                                                <a href="javascript:void(0)" onClick="fnAddNextItem(this);" name="addNextItem"><?php echo t('添加项'); ?></a> |
                                                                <a href="javascript:void(0)" onClick="fnAddItem(this);" name="addSubItem"><?php echo t('添加子项'); ?></a> |                                 
                                                                <a href="javascript:void(0)" onClick="fnRemoveItem(this);"  name="removeItem"><?php echo t('删除'); ?></a>  
                                                        </span>                                
                                                </div>
...
<div style="border-bottom:1px dotted #CCC; padding-bottom: 10px">
        <?php echo CHtml::button(t('增加下级项'), array('class' => 'button', 'name' => 'btnNewItem')); ?> 
</div>
