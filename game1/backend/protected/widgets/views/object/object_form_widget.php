        ...
        <div class="form-wrapper">
                ...
                <div id="form-body">
                        <div id="form-body-content">
                                ...
                                <?php $this->render('backwidgets.views.object.object_language_name_content_widget', array('model' => $model, 'type' => $type, 'form' => $form, 'versions' => $versions, 'lang_exclude' => $lang_exclude)); ?>

                                <div class="row">
                                        <!-- //Render Partial for Resource Binding -->
                                        <?php $this->render('backwidgets.views.object.object_resource_form_widget', array('model' => $model, 'type' => $type, 'content_resources' => $content_resources)); ?>                    	
                                </div>
