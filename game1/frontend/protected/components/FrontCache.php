<?php
        ...
        class FrontCache
        {
                ...
                public static function getNews()
                {
                        ...
                        FROM  `{{object}}` WHERE  `object_type`="article" AND `level`=1 AND `object_status`=1 ORDER BY `order` ASC LIMIT 0 , 8 ';
                ...
                public static function getGameArticle($teamid, $gameid, $limit)
                {
                        ...
                        WHERE t.`object_id` = o.`object_id` AND `object_parent`=' . $gameid . ' 
                                ...
                                AND `object_status`=1 
                                AND `term_id` = ' . $teamid . ' 
                                        ORDER BY `object_date` DESC LIMIT 0 , ' . $limit;
                ...
                public static function getCards()
                {
                        ...
                        $sql = 'SELECT * FROM  `{{object}}` WHERE  `object_type`="card" AND `object_status`=1 ORDER BY `order` ASC';
