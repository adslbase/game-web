...
$cs->registerCssFile($layout_asset . '/css/xxhzw/page.css');
?>
<div id="web_cont" class="wp">
	<div id="sider">
	     <div id="star_game"><a href="<?php echo $this->createUrl('xxhzw/server')?>" title="进入游戏" class="text_td">进入游戏</a></div>
                <div id="ka">
                        <ul>
                                <li><span></span><a href="javascript:;" title=""><img src="<?php echo $layout_asset . '/css/xxhzw/images/xsk.jpg' ?>" alt="领取新手卡" /></a></li>
	...
	<div id="cont">
    	<div id="conter">
        	<div id="title">
            	...
            	<dl>
                	<dt>您的当前位置-</dt>
                    <dd><a href="" title="">首页</a>-</dd>
                    <dd><a href="javascript:;" title="">游戏资料</a>-</dd>
                    <dd><a href="javascript:;" title="">帐号注册</a></dd>
                </dl>
            ...
            <div id="text">
            	<div id="text_warp">
            		<div id="text_title">
                	<h2><?php echo $object['object_name'] ?></h2>
                    <dl>
                    	<dt>时间：</dt>
