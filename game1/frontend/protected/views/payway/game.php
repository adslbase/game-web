                                ...
                                <div class="rightSide_cont" id="div2">
                                        ...
                                        <div class="paywayAll">
                                                <p class="paywayHeader">
                                                        您当前选择的是“<strong class="t_orange"><?php echo $payways[$paywayId]['name'] ?></strong>”支付方式<br>支持全国29家银行卡(需要开通网上银行)<em class="t_orange f12 fB">(点击左侧更换支付方式)</em>
                                                </p>
                                                <div class="payModel">
                                                        <h5> 选择您要充值到哪里</h5>
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="payTable">
                                                                <tr>
                                                                        ...
                                                                        <td width="33%"><div class="gamePay">
                                                                                        <span class="gameShow">
                                                                                                <em class="selectGame"> 
                                                                                                        <img src="<?php echo $game['ico_logo'] ?>" alt="csws" gid="102"><?php echo $game['object_name']; ?>
                                                                                                </em>
                                                                                                <input type="hidden" id="gameid" name="gameid" value="<?php echo $gameid; ?>">
                                                                                                <input type="hidden" id="gamename" name="gamename" value="<?php echo $game['object_name']; ?>">
                                                                                        </span>
