                        ...
                        <div class="leftSide_inner">
                                <div class="leftSide_cont" id="div1">
                                        <div class="mod_1 pay mgB10">
                                                <h2> 请选择充值方式</h2>
                                                <ul class="payway">
                                                        <?php $this->widget('frontwidgets.payways.PaywaysBlock',array('order'=>$order)); ?>
                                                </ul>
                                        </div>
                                        <br />
                                        <div id="paytip"> </div>
                ...
                <div class="rightSide">
                        <div class="rightSide_inner">
                                <div class="rightSide_cont" id="div2">
                                        <div class="paywayAll">
                                                <form method="POST" action="<?php echo $action?>" id="myform">
 <?php echo $code?>
                                                        
                                                        
                                                        <p class="paywayHeader">
                                                                <strong>确认充值信息</strong></p>
                                                        <div class=" payInfo">
                                                                ...
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="mgAuto mgB10 mgT20">
                                                                        <tbody><tr>
                                                                                ...
                                                                                <tr>
                                                                                        <td colspan="2">
                                                                                                <input type="submit" value="确认提交" class="submitBtn" hidefocus="">
                                                                                        </td>
                                                                                </tr>
                                                                        </tbody></table>
