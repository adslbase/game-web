                                                                ...
                                                                <div class=" payInfo">
                                                                        ...
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="mgAuto mgB10 mgT20">
                                                                                <tbody><tr>
                                                                                        ...
                                                                                        <tr>
                                                                                                <td colspan="2">
                                                                                                        <input type="button" value="继续充值" class="continueBtn" id="continueBtn" onclick="window.location = '<?php echo $this->createUrl('payway/game', array('gameid' => $order['gameid'])); ?>'"  hidefocus />
                                                                                                </td>
                                                                                        </tr>
                                                                                </tbody></table>         </div>
                                            </div>
